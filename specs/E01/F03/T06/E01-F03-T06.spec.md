...
files:
  ...
  - docs/architecture/E01-F03-T06/ci-cd-architecture.md
  - docs/walkthroughs/E01-F03-T06.md
...
- [x] CI pipeline runs on all PRs and main branch pushes
- [x] Affected builds and tests execute efficiently
