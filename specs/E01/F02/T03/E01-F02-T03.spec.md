...
- [[E01-F02-T01] Node.js and Yarn Environment Setup](../T01/E01-F02-T01.spec.md)

**Blocks:**

- [[E01-F02-T04] Environment Configuration and Secrets Management](../T04/E01-F02-T04.spec.md)
...
### Docker Compose Configuration ([`configs/docker/docker-compose.dev.yml`](../../../../configs/docker/docker-compose.dev.yml))
...
### Redis Configuration for Multi-Account ([`configs/database/redis.conf`](../../../../configs/database/redis.conf))
...
**PostgreSQL** ([`scripts/database/init-postgres.sql`](../../../../scripts/database/init-postgres.sql)):
...
- [`docker-compose.dev.yml`](../../../../docker-compose.dev.yml) - Complete Docker configuration with environment variables
- [`.env`](../../../../.env) - Centralized port and credential configuration
- [`.env.example`](../../../../.env.example) - Documentation and default configuration template
- [`configs/database/redis.conf`](../../../../configs/database/redis.conf) - Redis configuration for multi-account (5 KIS accounts)
- [`configs/database/clickhouse-config.xml`](../../../../configs/database/clickhouse-config.xml) - ClickHouse configuration
- [`scripts/database/init-postgres.sql`](../../../../scripts/database/init-postgres.sql) - PostgreSQL initialization with trading schemas
- [`scripts/database/init-mongo.js`](../../../../scripts/database/init-mongo.js) - MongoDB initialization with validated collections
- [`scripts/build/docker-setup.sh`](../../../../scripts/build/docker-setup.sh) - Cross-platform Docker installation script
- [`scripts/development/dev-services.sh`](../../../../scripts/development/dev-services.sh) - Service management with ports, backup, and test commands
