...
**Extensions Configuration** (`.vscode/extensions.json`): - NOT_FOUND
...
- [`.env.example`](../../../../.env.example) - Template with dummy values (committed to repository)
- [`.env.local`](../../../../.env.local) - Your actual credentials (gitignored, never committed)
...
**Development Services** ([`configs/docker/docker-compose.dev.yml`](../../../../configs/docker/docker-compose.dev.yml)):
...
{
  "scripts": {
    "dev:setup": "scripts/development/setup-dev-env.sh",
    ...
    "services:health": "node scripts/development/check-services-health.js",
...
- [`.vscode/extensions.json`](../../../../.vscode/extensions.json) - Recommended extensions - NOT_FOUND
- [`.vscode/launch.json`](../../../../.vscode/launch.json) - Debug configurations
- [`.env.example`](../../../../.env.example) - Environment template with dummy values
- [`.env.local`](../../../../.env.local) - Local credentials (gitignored)
- [`docker-compose.dev.yml`](../../../../docker-compose.dev.yml) - Local development services
- [`.pre-commit-config.yaml`](../../../../.pre-commit-config.yaml) - Code quality hooks
- [`scripts/development/setup-dev-env.sh`](../../../../scripts/development/setup-dev-env.sh) - Automated setup script
